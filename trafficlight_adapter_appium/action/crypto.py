...
def start_crosssign(driver, request: Request) -> Response:
    if "user_id" in request.data:
        ...
        driver.find_element("home_screen-verification_continue").click()
        time.sleep(5)  # the animation gets in the way of this click...

        driver.find_element("session_verification-request_verification").click()
        return Response({})
...
def accept_crosssign(driver, request: Request) -> Response:
    ...
    driver.find_element("session_verification-request_verification").click()
    driver.find_element("session_verification-start_sas_verification").click()
    return Response({})
...
def verify_crosssign(driver, request: Request) -> Response:
    ...
    driver.find_element('session_verification-accept_challenge').click()
    return Response({})
